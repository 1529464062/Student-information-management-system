    ...
    public partial class View_Course : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (CourseId != -1)
            {
                ...
                DataTable dt = view_Course_BLL.GetListByPage("CourseId=" + CourseId,"" , startIndex, endIndex).Tables[0];
                StringBuilder JsonString = new StringBuilder();
                JsonString.Append("{");
                JsonString.Append("\"RecordCount\":");
                JsonString.Append("\"" + view_Course_Dal.GetRecordCount("CourseId=" + CourseId) + "\",");
