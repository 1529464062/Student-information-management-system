...
namespace Maticsoft.DAL
{
	...
	public partial class student_course
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "student_course"); 
		}
		...
		public int Add(Maticsoft.Model.student_course model)
		{
			...
			strSql.Append("StudentId,CourseId,CourseScore)");
			...
			parameters[2].Value = model.CourseScore;
		...
		public Maticsoft.Model.student_course GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,StudentId,CourseId,CourseScore from student_course ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.student_course model=new Maticsoft.Model.student_course();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.student_course DataRowToModel(DataRow row)
		{
			Maticsoft.Model.student_course model=new Maticsoft.Model.student_course();
			if (row != null)
			{
				...
				if(row["CourseScore"]!=null && row["CourseScore"].ToString()!="")
				{
					model.CourseScore=decimal.Parse(row["CourseScore"].ToString());
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,StudentId,CourseId,CourseScore ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,StudentId,CourseId,CourseScore ");
			strSql.Append(" FROM student_course ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
